...
class Product
{
  ...
  public function __construct($_id, $_name, $_category_id, $_brand_id, $_price, $_location, $_point_of_restock, $_active, $_image = null, $_short_description = null)
  {
    $this->id                 = $_id;
    $this->name               = $_name;
  ...
  {
    global $db;
    $sql = "SELECT p.id, p.name, p.price,p.short_description	, p.location, b.name as brand, c.name as category, p.active, p.image 
