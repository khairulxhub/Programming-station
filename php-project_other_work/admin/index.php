...
<body>
  <div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
      ...
      <div class="sidebar-user">
        <img class="avatar-img avatar-md sidebar-user-avatar" src="<?php echo BASE_URL_ADMIN; ?>assets/images/avatar/avatar.jpg" alt="Khairul Hasan">
          ...
          <div class="navbar-actions ms-auto">
            ...
            <div class="dropdown">
              <button class="profile-button dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="avatar-img avatar-sm" src="<?php echo BASE_URL_ADMIN; ?>assets/images/avatar/avatar.jpg" alt="Admin Hasan">
              ...
              <table class="table align-middle mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Viewer</td>
                    <td>Finance</td>
                    <td><span class="badge text-bg-secondary">Active</span></td>
                    <td>Apr 07, 2026</td>
                    <td class="text-end"><a class="btn btn-light btn-sm" href="user-details.html">View</a></td>
                  </tr>
                  <tr>
  ...
  <script src="<?php echo BASE_URL_ADMIN; ?>assets/js/bootstrap.bundle.min.js"></script>
  <script src="<?php echo BASE_URL_ADMIN; ?>assets/js/main.js"></script>
</body>
</html>
